...
class AppUploadedFile {
  ...
  @override
  String toString() =>
      'AppUploadedFile(name: $name, bytes: ${bytes?.length ?? 0}, height: $height, width: $width, blurHash: $blurHash, originalFilename: $originalFilename,)';
  ...
  static AppUploadedFile deserialize(String val) {
